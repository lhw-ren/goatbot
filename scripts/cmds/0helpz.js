  ...
  onStart: async function ({ message, args, event, threadsData, role }) {
    ...
    if (args.length === 0) {
      ...
      const helpListImages = [
        "https://i.ibb.co/zG7XTqy/image.gif",
        "https://i.ibb.co/Fqj4ShJ/image.gif",
        "https://i.ibb.co/85ZvkKX/image.gif",
        "https://i.ibb.co/6wCGdh4/image.gif",
        "https://i.ibb.co/25NSMXF/image.gif",
      ];
